...
hero:
  ...
  text: 面向AList / OpenList云盘的B站收藏夹持续备份系统
...
features:
  - icon: ☁️
    title: 云盘持续归档
    details: 使用BBDown下载收藏内容，并通过AList或OpenList WebDAV持续写入目标网盘。
  - icon: ♻️
    title: 中断自动恢复
...
- 通过AList或OpenList WebDAV上传，并在远端文件真正可见后确认备份完成。
- 使用本地归档库统一浏览当前与已停用收藏夹中的历史归档。

## 适合什么场景

- 已经使用AList或OpenList管理阿里云盘、夸克、百度网盘或115等存储。
...
2. 准备上传：[连接 AList / OpenList](/alist/overview)
