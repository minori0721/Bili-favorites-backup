...
- 分支：`dev`
- 基准版本：`2.4.3`
- 当前dev变更：收藏夹“查看详情”统一数据源并修复已上传后失效视频的标题、封面与状态展示；新增AList归档播放器及稳定队列交互；Archiver升级到8.0.0。
...
- 脱敏播放器预览扩展为36个可播放视频，可覆盖一屏以上及30项分页边界。浏览器实测390x844下同页、分P、上下项、自动连播和第30到31项跨页均保持外层视角；1280x720下右栏独立滚动且焦点保留，844x390无横向溢出，控制台无警告或错误。
